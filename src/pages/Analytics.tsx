...
const Analytics = () => {
  ...
  const complexityData = allQuestions.map((q, i) => ({
    name: `Q${i + 1}`,
    ...
    <div className="space-y-6">
      ...
      {allQuestions.length === 0 ? (
        <div className="rounded-xl border border-border bg-card p-12 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">Analytics will appear once assessments with questions have been uploaded.</p>
        </div>
      ) : (
